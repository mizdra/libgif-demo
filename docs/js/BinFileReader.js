 ...
 */
/**
 * This code was modified by mizdra(http://mizdora.blog.fc2.com/).
 */
...
function BinFileReader(fileURL){
	...
	function BinFileReaderImpl(fileURL){
                                    if(fileURL.slice(0, 5) == 'data:'){
                                                    fileContents = base64decode(fileURL.split(',')[1]);
	...
	if((/msie/i.test(navigator.userAgent) && !/opera/i.test(navigator.userAgent)) && fileURL.slice(0, 5) != 'data:')
